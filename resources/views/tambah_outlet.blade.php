                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" class="">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nf-email" name="nf-email" placeholder="Masukkan nama outlet.." class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">Alamat Outlet</label>
                                                <input type="text" id="nf-email" name="nf-email" placeholder="Masukkan alamat outlet.." class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">No HP</label>
                                                <input type="text" id="nf-email" name="nf-email" placeholder="Masukkan No HP outlet.." class="form-control">
                                            </div>
                                        </form>
                                    </div>
